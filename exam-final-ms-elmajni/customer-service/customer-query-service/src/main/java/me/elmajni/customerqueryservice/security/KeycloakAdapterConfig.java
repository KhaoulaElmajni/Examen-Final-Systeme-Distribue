package me.elmajni.customerqueryservice.security;
...
public class KeycloakAdapterConfig {
 /*   @Bean
    public KeycloakSpringBootConfigResolver (){   //=> il permet de dire au keycloak de lire le fichier application.properties
